...
public class GreaterThanExpression extends BinaryExpression implements Expression
{
    /**
    ...
    public GreaterThanExpression(Expression expressionA, Expression expressionB, Expression errorRecoveryExpression)
    {

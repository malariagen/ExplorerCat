...
public class LessOrEqualThanExpression extends BinaryExpression implements Expression
{
    /**
    ...
    public LessOrEqualThanExpression(Expression expressionA, Expression expressionB, Expression errorRecoveryExpression)
    {
	...
	{
	    int comparison = Float.compare(valueA.getValueAsReal(), valueB.getValueAsReal());
	    return new BooleanValue(comparison == 0 || comparison < 0);
	}
	else

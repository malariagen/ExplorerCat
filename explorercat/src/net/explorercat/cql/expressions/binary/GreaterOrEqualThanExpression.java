...
public class GreaterOrEqualThanExpression extends BinaryExpression implements Expression
{
    /**
    ...
    public GreaterOrEqualThanExpression(Expression expressionA, Expression expressionB,

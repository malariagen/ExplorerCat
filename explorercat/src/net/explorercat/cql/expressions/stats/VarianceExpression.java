...
public class VarianceExpression extends StatisticalFunctionExpression implements Expression
{
    /**
    ...
    public VarianceExpression(String attributeName, Expression variableExpression, Selection sourceSelection,
	...
	if(variableExpression == null)
	    return new RealValue(sourceSelection.getStatsForProperty(propertyName, StatsType.VAR));
	else
    ...
    {
	return ExpressionType.VARIANCE;
    }
}

...
/**
 * Statistical function: Maximum.
 * 
 * @author Jacob Almagro Garcia - jg10@sanger.ac.uk
 * @date July 2010
 */

public class MaximumExpression extends StatisticalFunctionExpression implements Expression
{
    /**
    ...
    public MaximumExpression(String attributeName, Expression variableExpression, Selection sourceSelection,
	...
	if(variableExpression == null)
	    return new RealValue(sourceSelection.getStatsForProperty(propertyName, StatsType.MAX));
	else

...
public class MinimumExpression extends StatisticalFunctionExpression implements Expression
{
    /**
    ...
    public MinimumExpression(String attributeName, Expression variableExpression, Selection sourceSelection,
	...
	if(variableExpression == null)
	    return new RealValue(sourceSelection.getStatsForProperty(propertyName, StatsType.MIN));
	else

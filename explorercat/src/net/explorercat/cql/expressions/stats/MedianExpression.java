...
public class MedianExpression extends StatisticalFunctionExpression implements Expression
{
    /**
    ...
    public MedianExpression(String attributeName, Expression variableExpression, Selection sourceSelection,
	...
	if(variableExpression == null)
	    return new RealValue(sourceSelection.getStatsForProperty(propertyName, StatsType.MEDIAN));
	else
